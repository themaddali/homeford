define(['modernizr', 'cookie', '../../service/DataService', '../../service/BannerService', '../../Router', '../../Notify', 'paypal'], function(modernizr, cookie, service, banner, router, notify, paypal) {"use strict";
